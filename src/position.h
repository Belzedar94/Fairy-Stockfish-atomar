...
public:
  ...
  bool royal_immunity_blast() const;
...
inline bool Position::blast_on_capture() const {
  assert(var != nullptr);
  return var->blastOnCapture || var->royalImmunityBlast;
}

inline bool Position::royal_immunity_blast() const {
  assert(var != nullptr);
  return var->royalImmunityBlast;
}
